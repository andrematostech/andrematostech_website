...
export default function SectionScrollIndicator({
  ...
  return (
    <button
      ...
      className={`absolute bottom-8 left-1/2 z-20 flex -translate-x-1/2 flex-col items-center gap-2 transition-colors sm:bottom-10 ${className}`}
    >
      <span className="text-[10px] uppercase tracking-[0.42em]">{label}</span>
